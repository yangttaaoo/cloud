package com.cist.device.service;
...
public interface DeviceService {
	 ...
	 Object querypolpageList(HashMap<String,Object> map,PageInfo pinfo); 
	 Sys_device_grouping querydept(String groud_dev);
	 Sys_device_grouping querydeptpol(HashMap<String,Object> map);
