...
public class QueryCarinfoService {
	public static void main(String[] args) throws JsonProcessingException {
		QueryCarinfoService q=new QueryCarinfoService();
		Map<String,String> map=new HashMap<String, String>();
		map.put("hphm", "川A59623");
		map.put("hpzl", "16");
		Vehicle v=	q.queryVechile(map);
		System.err.println(v.getHpzl());
		System.err.println(v.getHpzlName());
