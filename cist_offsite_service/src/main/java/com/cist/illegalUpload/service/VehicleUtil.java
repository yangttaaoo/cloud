...
public class VehicleUtil {
	...
	public static String writeObjectOut_zhijie(String dywf,String xtlb,String jkxlh,String jkid,StringBuffer WriteXmlDoc){
		try {
			 String webserviceUrl="http://10.69.199.131:9080/zjxtService/services/TmriOutAccess?wsdl";
	...
	public String Uploadillage_wsh(String vio,Map<String, String> map){
		try {
			...
			if(wxml != null && !"".equals(wxml)){
				String restr = writeObjectOut_zhijie("writeObjectOut","04","S18AB89931009DEZ6578E6CB6A071B","04C52",wxml);
	...
	public static String search_car(String vio,Map<String, String> map){
		try {
			...
			if(wxml != null && !"".equals(wxml)){
				return writeObjectOut_zhijie("queryObjectOut", "A0", "S18AB89931009DEZ6578E6CB6A071B", "A0A99", wxml);//查
			}
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
