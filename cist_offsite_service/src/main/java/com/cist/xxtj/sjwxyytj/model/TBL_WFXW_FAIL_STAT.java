 ...
 *
 */
public class TBL_WFXW_FAIL_STAT implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 288162760593581357L;
	private Integer pk;//ID
    private String glbm;//管理部门（中文）
    private Integer wxzs;//上传失败总数
    private String wfxwtj;//上传失败原因（JSON格式，{上传失败原因代码：数量}）
