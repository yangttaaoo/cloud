...
public class DeptInfo implements Serializable{
	...
	public DeptInfo(Integer dept_pk, String dept_code, String name, Integer dept_superior, List<DeptInfo> children,
			Boolean selectable, Boolean isLeaf, String tbei_code, String tbei_name, String tbec_dept_id) {
		super();
