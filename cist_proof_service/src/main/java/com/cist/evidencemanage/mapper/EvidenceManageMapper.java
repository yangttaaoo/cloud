package com.cist.evidencemanage.mapper;
...
public interface EvidenceManageMapper {
	 /***
	    * 新增证据信息
	...
	Integer save(HashMap<String,Object> map);
	 ...
	 /***
	    ...
	    */
	List<ZjjhEvidenceInfo> list(HashMap<String,Object> map); 
	...
	List<ZjjhEvidenceInfo> selectPsw(HashMap<String,Object> map);
	 ...
	 /***
	    ...
	    * @return Integer
	    */
	Integer updateAll(HashMap<String,Object> map);
