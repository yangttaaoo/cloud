...
public class ZjjhEvidenceInfo {
    ...
    private BigDecimal fk_evidence_type_id;//证据类型（参考SYS_FRM_CODE表 FCT_CODE=E001）

    private BigDecimal fk_involved_type_id;//涉案类型（参考SYS_FRM_CODE表 FCT_CODE=E002）
	...
	public BigDecimal getFk_evidence_type_id() {
		return fk_evidence_type_id;
	}

	public void setFk_evidence_type_id(BigDecimal fk_evidence_type_id) {
		this.fk_evidence_type_id = fk_evidence_type_id;
	}

	public BigDecimal getFk_involved_type_id() {
		return fk_involved_type_id;
	}

	public void setFk_involved_type_id(BigDecimal fk_involved_type_id) {
