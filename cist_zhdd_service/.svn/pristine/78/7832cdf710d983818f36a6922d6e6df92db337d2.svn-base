package com.cist.specialTask.mapper;
...
public interface SpecialTaskMapper {
	...
	//特勤任务查询
	List<ZhddSpecialMission> list(HashMap<String,Object> map);
	 ...
	 * @return
	 */
	Integer insertRoute(HashMap<String, Object> map);
	 ...
	 * @return
	 */
	Integer insertParticipant(HashMap<String, Object> map);
