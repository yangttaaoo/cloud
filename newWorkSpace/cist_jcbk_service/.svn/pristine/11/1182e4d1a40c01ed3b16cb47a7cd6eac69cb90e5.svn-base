...
public class DeviceBayonetLane {
	...
	//
	private String connectDevDirection;
	
	
	public String getConnectDevDirection() {
		return connectDevDirection;
	}

	public void setConnectDevDirection(String connectDevDirection) {
		this.connectDevDirection = connectDevDirection;
	}
