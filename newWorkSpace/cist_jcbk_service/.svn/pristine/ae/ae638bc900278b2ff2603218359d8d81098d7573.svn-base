...
public class Jcbk_control_bayonet implements Serializable{
	...
	private List<BayonetDev>  bayonetDevList;
	private List<BayonetArea>  bayonetAreaList;
	...
	public List<BayonetDev> getBayonetDevList() {
		return bayonetDevList;
	}

	public void setBayonetDevList(List<BayonetDev> bayonetDevList) {
		this.bayonetDevList = bayonetDevList;
	}

	public List<BayonetArea> getBayonetAreaList() {
		return bayonetAreaList;
	}

	public void setBayonetAreaList(List<BayonetArea> bayonetAreaList) {
		this.bayonetAreaList = bayonetAreaList;
	}
