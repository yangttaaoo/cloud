package com.cist.earlyewarningpost.service;
...
public interface EarlyeWarningPostService {
	...
	Object selectPoliceListpageList(HashMap<String,Object> map,PageInfo pinfo); 
	Object selectListpageList(HashMap<String,Object> map,PageInfo pinfo); 
	 ...
	 * @return Integer
	 */
	Integer savePic(HashMap<String, Object> map,List<MultipartFile> files);
	 ...
	 * 预警信息  反馈附件信息
	 * 
	 * @return List<JcbkWarningAttachment>
	 */
	 ...
	 */
 	...
 	/**
	 * 查询布控卡口对应的区域信息
	 * @return List<JcbkFenceArea>
	 */
 	List<JcbkFenceArea>selectArea(HashMap<String, Object> map);
