package com.cist.interceptRegion.model;
...
public class FenceArea {
	...
	private int area_nums;
	
	
	private String title;
	private long key;
	private List<FenceArea> children = null;
	...
	public String getGlbm_name() {
		if(0!=glbm)
		return SysTempStoreUtils.getFcName(SysBaseDataCode.SYS_DEPT, Long.toString(glbm));
		return null;
	}
	...
	public void setArea_nums(int area_nums) {
	...
	public List<FenceArea> getChildren() {
		return children;
	}

	public void setChildren(List<FenceArea> children) {
	...
	public String getFk_dept_name() {
		if(null==this.fk_dept_name) {
			return SysTempStoreUtils.getFcName(SysBaseDataCode.SYS_DEPT, Long.toString(this.fk_dept_id));
		}
		return fk_dept_name;
	}
