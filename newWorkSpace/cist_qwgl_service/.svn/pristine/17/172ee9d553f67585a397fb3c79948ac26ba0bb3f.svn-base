...
public class QWAppraiseFeedbackResponse {
    ...
    private BigDecimal fk_assessment_id;//勤务考核ID（个人或者单位考核ID）
    ...
    private BigDecimal fk_user_id;//反馈/回复人ID
	...
	public BigDecimal getFk_assessment_id() {
		return fk_assessment_id;
	}

	public void setFk_assessment_id(BigDecimal fk_assessment_id) {
	...
	public BigDecimal getFk_user_id() {
		return fk_user_id;
	}

	public void setFk_user_id(BigDecimal fk_user_id) {
