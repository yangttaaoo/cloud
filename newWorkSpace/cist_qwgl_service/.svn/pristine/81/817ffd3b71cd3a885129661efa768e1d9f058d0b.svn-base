...
public class Oeuser  implements  Serializable{
	...
	private static final long serialVersionUID = 5294524870098069170L;
	 private Long wfpk;//ID
	    ...
	    private String shbz;//审核标志(0-未审核1-初审通过 2-复审通过3-初审作废 4-复审作废 5-作废数据有效7-上传成功 8-上传失败9-上传其它标志10-删除标志11-其它13-上传队列 14-导出 15-初筛通过 16-初筛作废)
		...
		private String hpzlnamez;
		private String device_name;
		
		public String getHpzlnamez() {
			return hpzlnamez;
		}

		public void setHpzlnamez(String hpzlnamez) {
			this.hpzlnamez = hpzlnamez;
		}
		...
		public String getShbzname() {
			if ("1".equals(shbz)){
				...
				return "复审通过";
			}else if ("3".equals(shbz)) {
				return "初审作废";
			}else if ("4".equals(shbz)) {
				return "复审作废";
			}else if ("7".equals(shbz)) {
				return "上传成功";
