...
public class RealTimeMonitorController {
	...
	@RequestMapping("initDeptDeviceTree")
	public HashMap<String, Object> initDeptDeviceTree(@RequestBody HashMap<String, Object> paramMap)  {
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
	resultMap.putAll(service.initDeptDeviceTree());
	...
	@RequestMapping("initAdministrativeAreasTree")
	public HashMap<String, Object> initAdministrativeAreasTree()
			throws JsonProcessingException {
		HashMap<String, Object> initAdministrativeAreasTree = service.initAdministrativeAreasTree();
		return initAdministrativeAreasTree;
	}
