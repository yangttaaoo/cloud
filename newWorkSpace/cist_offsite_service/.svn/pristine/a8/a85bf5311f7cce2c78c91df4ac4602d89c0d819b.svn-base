...
public class TblOffeEvdiInfo implements Serializable {
	private static final long serialVersionUID = 4142194355606060353L;
...
//	private String tboc_fines;// 罚款金额
	...
	private int isFirst = 1;// 是否为第一页

	private int isLast = 1;// 是否为最后一页

	private String shbz1;
	// 六合一信息
...
//	}
	...
	public void setShbz1(String shbz1) {
		this.shbz1 = shbz1;
	}
