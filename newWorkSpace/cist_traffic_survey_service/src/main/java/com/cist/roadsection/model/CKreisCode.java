...
public class CKreisCode {
    private Integer tbek_pk;

    private String tbek_code;

    private String tbek_name;

    private Long tbek_level;

    private Long tbek_parent;

    private String tbek_simp_spell;

    private String tbek_first_letter;

    private String tbek_mapid;

    private String tbek_flag;

    private String tbek_map_box;
    
    private List<CKreisCode> children;
	...
	public Long getTbek_level() {
		return tbek_level;
	}

	public void setTbek_level(Long tbek_level) {
		this.tbek_level = tbek_level;
	}

	public Long getTbek_parent() {
		return tbek_parent;
	}

	public void setTbek_parent(Long tbek_parent) {
