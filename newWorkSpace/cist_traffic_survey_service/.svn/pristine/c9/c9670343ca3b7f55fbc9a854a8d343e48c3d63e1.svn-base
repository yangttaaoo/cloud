...
public class Device implements  Serializable{
	...
	//创建人部门名称
	private String create_person_dept_name;
	//创建人名称
	...
	public String getCreate_person_name() {
		return com.cist.frame.utils.SysTempStoreUtils.getFcName(SysBaseDataCode.SYS_USER,Long.toString(create_person) );
	}
	...
	public String getCreate_person_dept_name() {
		return SysTempStoreUtils.getCreatePersonDeptName(create_person);
	}

	public void setCreate_person_dept_name(String create_person_dept_name) {
		this.create_person_dept_name = create_person_dept_name;
	}

	public String getCheck_person_name() {
		return com.cist.frame.utils.SysTempStoreUtils.getFcName(SysBaseDataCode.SYS_USER, check_person_id);
	}
...
/*	public HashMap<String, Object> getDevice_audit_state() {
	...
	public int getKilometre_num() {
		return Integer.valueOf(kilometre_num).intValue();
	}



	public void setKilometre_num(String kilometre_num) {
		this.kilometre_num = getLenString(kilometre_num,4);
	}



	public int getMeter_num() {
		return Integer.valueOf(meter_num).intValue();
	}



	public void setMeter_num(String meter_num) {
		this.meter_num = getLenString(meter_num,3);
	}
