 ...
 *
 */
public class Qw_car_patrol_relation implements Serializable{
    ...
    private Jcsj_police_res_person syspoliceinfo;//关联警员
	...
	public Qw_car_patrol_relation(Integer pk_id, String fk_car_patrol_id, String fk_user_id, String user_type) {
		super();
		this.pk_id = pk_id;
		this.fk_car_patrol_id = fk_car_patrol_id;
		this.fk_user_id = fk_user_id;
