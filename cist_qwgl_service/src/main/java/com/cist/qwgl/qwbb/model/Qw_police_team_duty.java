...
public class Qw_police_team_duty implements Serializable{
    ...
    private Qwgl_bc_info qwgl_bc_info;//班次信息
    private List<Qw_duty_relation> qw_duty_relation;//9.7.	值班值守关联人员信息
	...
	public List<Qw_duty_relation> getQw_duty_relation() {
		return qw_duty_relation;
	}
	public void setQw_duty_relation(List<Qw_duty_relation> qw_duty_relation) {
		this.qw_duty_relation = qw_duty_relation;
	}
