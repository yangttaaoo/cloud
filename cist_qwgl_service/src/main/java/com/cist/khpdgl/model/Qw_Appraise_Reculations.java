...
public class Qw_Appraise_Reculations implements Serializable{
	...
	private String assessment_num_name;//条例分值
	...
	public String getCreate_tname() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		create_tname = sdf.format(this.create_time);
		return create_tname;
	}
	public void setCreate_tname(String create_tname) {
		this.create_tname = create_tname;
	}
	...
	public String getEnabled_state_name() {
		if (enabled_state.equals("0")){
			return "禁用";
		}else if (enabled_state.equals("1")){
			return "启动";
		}
		return enabled_state_name;
	}
	public void setEnabled_state_name(String enabled_state_name) {
		this.enabled_state_name = enabled_state_name;
	}
	public String getAssessment_name() {
		if (assessment_rules.equals("0")){
			return "零分";
		}else if (assessment_rules.equals("1")) {
			return "加分";
		}else if (assessment_rules.equals("2")) {
			return "减分";
		}
	...
	public String getAssessment_num_name() {
		if (assessment_rules.equals("1")){
			return "+" + assessment_rules.toString();
		}else if (assessment_rules.equals("2")) {
			return "-" + assessment_rules.toString();
		}else if (assessment_rules.equals("0")) {
			return assessment_rules.toString();
		}
		return assessment_num_name;
	}
	public void setAssessment_num_name(String assessment_num_name) {
		this.assessment_num_name = assessment_num_name;
	}
