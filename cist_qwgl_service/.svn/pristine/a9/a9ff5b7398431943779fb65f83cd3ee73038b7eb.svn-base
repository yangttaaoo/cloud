...
public class Qw_sign_in implements Serializable{
	...
	private String fk_sign_in_user_id;//签到人id
	...
	public String getFk_sign_in_user_id() {
		return fk_sign_in_user_id;
	}
	public void setFk_sign_in_user_id(String fk_sign_in_user_id) {
	...
	public Qw_sign_in(Integer pk_id, String fk_dept_id, String fk_report_id, String fk_sign_in_user_id,
			Integer sign_in_type, String sign_in_user_name, String sign_in_user_unit, Date sign_time,
			String sign_in_addr, String longitude, String latitude) {
		super();
		this.pk_id = pk_id;
		this.fk_dept_id = fk_dept_id;
		this.fk_report_id = fk_report_id;
