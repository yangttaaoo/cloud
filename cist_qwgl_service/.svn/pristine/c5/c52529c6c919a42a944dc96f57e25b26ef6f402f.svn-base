...
public class Qw_equip_info implements Serializable{
    ...
    private List<Qw_guns_relation> qw_guns_relation;//枪支关联警员信息
	...
	public List<Qw_guns_relation> getQw_guns_relation() {
		return qw_guns_relation;
	}
	public void setQw_guns_relation(List<Qw_guns_relation> qw_guns_relation) {
		this.qw_guns_relation = qw_guns_relation;
	}
	...
	public Qw_equip_info(Integer pk_id, Integer fk_police_team_id, Integer guns, Integer ammo, Integer mobile,
			Integer baton, Integer recorder, Integer handcuffs, Integer flashlight, Integer med_pack,
