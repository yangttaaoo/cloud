...
public class Qwgl_bc_info implements Serializable {
	...
	private Integer span_cycle;//跨越周期
	private Integer create_person;//创建人
	private Date create_time;//班次跨天

	public Integer getSpan_cycle() {
		return span_cycle;
	}
	public void setSpan_cycle(Integer span_cycle) {
