...
public class JzglController {
	...
	public PageInfo<Jcsj_police_res_person> policelist(@RequestBody HashMap<String,Object> modelMap ){
		if(modelMap.get("id").toString().length()>2){
			String[] id = modelMap.get("id").toString().substring(1, modelMap.get("id").toString().length()-1).split(",");
			modelMap.put("id", id);
		}else{
		...
		//获取分页数据位置,每页显示16条数据
 		PageHelper.startPage(Integer.valueOf(modelMap.get("currentPage").toString()),pageSize, true);
		List<Jcsj_police_res_person> list= service.selectpoliceinfo(modelMap);
	...
	public Integer saveinformation(@RequestBody HashMap<String,Object> modelMap,HttpServletRequest request) throws ParseException{
		try {
			...
			if(null!=modelMap.get("auxiliarypolice")&&!modelMap.get("auxiliarypolice").equals("")) {
			...
			for(int i=0;i<qwdutyrelation.size();i++){//值班人员
				 ...
				 if(!"".equals(json.get("Dutyleader").toString())) {
					 ...
					 for(int k=0;k<dutyleader.size();k++){
							...
							modelMap.put("fk_user_id", dutyleaderjso.get("id"));//人员id
				 ...
				 JSONArray commander = JSONArray.fromObject(json.get("Commander"));//指挥长
					 for(int k=0;k<commander.size();k++){
							...
							modelMap.put("fk_user_id", commanderjso.get("id"));//人员id
				 ...
				 JSONArray shiftforeman = JSONArray.fromObject(json.get("shiftforeman"));//值班长
					 for(int k=0;k<shiftforeman.size();k++){
							...
							modelMap.put("fk_user_id", shiftforemanjso.get("id"));//人员id
				 ...
				 JSONArray dutypolice = JSONArray.fromObject(json.get("Dutypolice"));//值班民警
					 for(int k=0;k<dutypolice.size();k++){
							...
							modelMap.put("fk_user_id", dutypolicejso.get("id"));//人员id
				 ...
				 JSONArray guardonduty = JSONArray.fromObject(json.get("Guardonduty"));//值班协警
					 for(int k=0;k<guardonduty.size();k++){
							...
							modelMap.put("fk_user_id", guardondutyjso.get("id"));//人员id
	...
	public HashMap<String,Object> querypolicecarbyjzid(@RequestBody HashMap<String,Object> map){
		...
		List<Jcsj_police_res_person> fuzeren = null;
		List<Jcsj_police_res_person> minjing = null;
		List<Jcsj_police_res_person> xiejing = null;
		for (int i = 0; i < cxinfo.size(); i++) {
			...
			minjingname="";
			xiejingname="";
			fuzeren = new ArrayList<Jcsj_police_res_person>();
			minjing = new ArrayList<Jcsj_police_res_person>();
			xiejing = new ArrayList<Jcsj_police_res_person>();
			for (int j = 0; j < carinfo.size(); j++) {
			
				if("1".equals(carinfo.get(j).getUser_type())) {//负责人
					map.put("id", carinfo.get(j).getFk_user_id());
					List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
					if(policeinfo!=null) {
						fuzerenname+=policeinfo.get(0).getXm()+",";
					...
					List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
					if(policeinfo!=null) {
						minjingname+=policeinfo.get(0).getXm()+",";
					...
					List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
					if(policeinfo!=null) {
						xiejingname+=policeinfo.get(0).getXm()+",";
	...
	public HashMap<String,Object> querybxrybyjzid(@RequestBody HashMap<String,Object> map){
		...
		List<Jcsj_police_res_person> fuzeren = new ArrayList<Jcsj_police_res_person>();
		List<Jcsj_police_res_person> minjing = new ArrayList<Jcsj_police_res_person>();
		List<Jcsj_police_res_person> xiejing = new ArrayList<Jcsj_police_res_person>();
		for (int i = 0; i < bxinfo.size(); i++) {
			if("1".equals(bxinfo.get(i).getUser_type())) {//负责人
				map.put("id", bxinfo.get(i).getFk_user_id());
				List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
				if(policeinfo!=null) {
					fuzerenname+=policeinfo.get(0).getXm()+",";
					fuzeren.add(policeinfo.get(0));
	...
	public HashMap<String,Object> queryequip(@RequestBody HashMap<String,Object> map){
		HashMap<String,Object> ModelMap = new HashMap<String,Object>();
		List<Jcsj_police_res_person> policeinfo= new ArrayList<Jcsj_police_res_person>();
		String policename="";
		...
		for (int i = 0; i < equip.size(); i++) {
			...
			for (int j = 0; j < gunslist.size(); j++) {
				map.put("id", gunslist.get(j).getFk_user_id());//警员
				List<Jcsj_police_res_person> police = service.selectpolice(map);
				if(policeinfo!=null) {
					policename+=police.get(0).getXm()+",";
	...
	public HashMap<String,Object> queryzbzs(@RequestBody HashMap<String,Object> map){
		...
		List<Jcsj_police_res_person> Dutyleader = new ArrayList<Jcsj_police_res_person>();//值班领导
		List<Jcsj_police_res_person> Commander = new ArrayList<Jcsj_police_res_person>();//指挥长
		List<Jcsj_police_res_person> shiftforeman = new ArrayList<Jcsj_police_res_person>();//值班长
		List<Jcsj_police_res_person> Dutypolice = new ArrayList<Jcsj_police_res_person>();//值班民警
		List<Jcsj_police_res_person> Guardonduty = new ArrayList<Jcsj_police_res_person>();//值班协警
		...
		for (int i = 0; i < Qw_duty_relation.size(); i++) {
			...
			if("1".equals(Qw_duty_relation.get(i).getUSER_TYPE().toString())) {
				map.put("id", Qw_duty_relation.get(i).getFk_user_id());
				List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
				if(policeinfo!=null) {
					Dutyleadername+=policeinfo.get(0).getXm()+",";
				...
				List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
				if(policeinfo!=null) {
					Commandername+=policeinfo.get(0).getXm()+",";
				...
				List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
				if(policeinfo!=null) {
					shiftforemanname+=policeinfo.get(0).getXm()+",";
				...
				List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
				if(policeinfo!=null) {
					Dutypolicename+=policeinfo.get(0).getXm()+",";
				...
				List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
				if(policeinfo!=null) {
					Guardondutyname+=policeinfo.get(0).getXm()+",";
		...
		try {
			...
			for (int i = 0; i < jzlist.size(); i++) {
				...
				if ("1".equals(jzlist.get(i).getReport_type())) {// 判断是否为街面勤务
					...
					service.delzbzs(map);
					service.delQw_police_team(map);//根据警组id删除警组信息
				} else if ("3".equals(jzlist.get(i).getReport_type())) {// 接警处
	...
	public Integer updatejz(@RequestBody HashMap<String, Object> map) {
		...
		try {
			...
			}else if("3".equals(jzinfo.getReport_type())){//更新前为接警处
			...
			if("1".equals(map.get("report_type"))){//更新的数据为街面勤务
				...
				if(null!=map.get("auxiliarypolice")&&!map.get("auxiliarypolice").equals("")) {
					 ...
					 map.put("fk_car_patrol_id", patrolpk);//车巡信息id
						 if(null!=json.get("fuzeren")&&!json.get("fuzeren").equals("null")&&!json.get("fuzeren").equals("")) {
							 map.put("qw_car_patrol_relation_user_type", 1);//关联人员类型（1：负责人；2：民警；3：协警）
								 ...
								 for(int k=0;k<fuzeren.size();k++){
									 JSONObject fuzerenjson=fuzeren.getJSONObject(k);
									 map.put("qw_car_patrol_relation_fk_user_id",fuzerenjson.get("id"));
						...
						if(null!=json.get("xiejing")&&!json.get("xiejing").equals("null")&&!json.get("xiejing").equals("")) {
							 map.put("qw_car_patrol_relation_user_type", 3);//关联人员类型（1：负责人；2：民警；3：协警）
								 ...
								 for(int k=0;k<xiejing.size();k++){
									 JSONObject xiejingjson=xiejing.getJSONObject(k);
									 map.put("qw_car_patrol_relation_fk_user_id",xiejingjson.get("id"));
									 service.saveqw_car_patrol_relation(map);
								 }
						...
						if(null!=json.get("minjing")&&!json.get("minjing").equals("null")&&!json.get("minjing").equals("")) {
							 map.put("qw_car_patrol_relation_user_type", 2);//关联人员类型（1：负责人；2：民警；3：协警）
								 ...
								 for(int k=0;k<minjing.size();k++){
									 JSONObject minjingjson=minjing.getJSONObject(k);
									 map.put("qw_car_patrol_relation_fk_user_id",minjingjson.get("id"));
									 service.saveqw_car_patrol_relation(map);
								 }
						}
				...
				if(!gunsdata.toString().equals("[null]")) {
					for(int i=0;i<gunsdata.size();i++){//枪支关联警员
						JSONObject json=gunsdata.getJSONObject(i);
						map.put("fk_user_id", json.get("id"));
				...
				for(int i=0;i<qwdutyrelation.size();i++){//值班人员
					 ...
					 if(!"".equals(json.get("Dutyleader").toString())) {
						 ...
						 for(int k=0;k<dutyleader.size();k++){
								JSONObject dutyleaderjso=dutyleader.getJSONObject(k);
								map.put("fk_user_id", dutyleaderjso.get("id"));//人员id
					 ...
					 JSONArray commander = JSONArray.fromObject(json.get("Commander"));//指挥长
						 for(int k=0;k<commander.size();k++){
								JSONObject commanderjso=commander.getJSONObject(k);
								map.put("fk_user_id", commanderjso.get("id"));//人员id
					 ...
					 JSONArray shiftforeman = JSONArray.fromObject(json.get("shiftforeman"));//值班长
						 for(int k=0;k<shiftforeman.size();k++){
								JSONObject shiftforemanjso=shiftforeman.getJSONObject(k);
								map.put("fk_user_id", shiftforemanjso.get("id"));//人员id
					 ...
					 JSONArray dutypolice = JSONArray.fromObject(json.get("Dutypolice"));//值班民警
						 for(int k=0;k<dutypolice.size();k++){
								JSONObject dutypolicejso=dutypolice.getJSONObject(k);
								map.put("fk_user_id", dutypolicejso.get("id"));//人员id
					 ...
					 JSONArray guardonduty = JSONArray.fromObject(json.get("Guardonduty"));//值班协警
						 for(int k=0;k<guardonduty.size();k++){
								JSONObject guardondutyjso=guardonduty.getJSONObject(k);
								map.put("fk_user_id", guardondutyjso.get("id"));//人员id
			...
			}else if("3".equals(map.get("report_type"))){//更新的数据为接处警
				map.put("fk_police_team_id", map.get("jz_id"));//警组ID
				service.addjjc(map);
				
				//添加
				if(!"".equals(map.get("jjcxiejing"))&&map.get("jjcminjing")!=null) {
					 ...
					 for (int i = 0; i < jjcxiejing.size(); i++) {
						 ...
						 map.put("fk_user_id", jjcxj.get("id"));//人员id
						 map.put("user_type", 2);//协警
						 service.addjjcglry(map);//添加接处警关联人员信息
					}
				}
				if(!"".equals(map.get("jjcminjing"))&&map.get("jjcminjing")!=null) {
					 ...
					 for (int i = 0; i < jjcminjing.size(); i++) {
						 ...
						 map.put("fk_user_id", jjcmj.get("id"));//人员id
			...
			try {
				...
				if(!"".equals(modelMap.get("jjcxiejing"))) {
					 ...
					 if(!"[null]".equals(jjcxiejing.toString())){
						 for (int i = 0; i < jjcxiejing.size(); i++) {
							 JSONObject jjcxj=jjcxiejing.getJSONObject(i);
							 modelMap.put("fk_user_id", jjcxj.get("id"));//人员id
				...
				if(!"".equals(modelMap.get("jjcminjing"))) {
					 ...
					 for (int i = 0; i < jjcminjing.size(); i++) {
						 JSONObject jjcmj=jjcminjing.getJSONObject(i);
						 modelMap.put("fk_user_id", jjcmj.get("id"));//人员id
	...
	public HashMap<String,Object> queryjcj(@RequestBody HashMap<String,Object> map){
		...
		List<Jcsj_police_res_person> jjcminjing = new ArrayList<Jcsj_police_res_person>();//接处警民警信息
		List<Jcsj_police_res_person> jjcxiejing = new ArrayList<Jcsj_police_res_person>();//接处警协警信息
		String jjcminjingname = "";//接处警民警名字
		String jjcxiejingname = "";//接处警协警名字
		for (int i = 0; i < list.size(); i++) {
			if("1".equals(list.get(i).getUser_type())){//民警
				map.put("id", list.get(i).getFk_user_id());
				List<Jcsj_police_res_person> policeinfo = service.selectpolice(map);
				for (int j = 0; j < policeinfo.size(); j++) {
					jjcminjing.add(policeinfo.get(j));
					jjcminjingname+=policeinfo.get(j).getXm()+",";
				}
				...
				for (int j = 0; j < policeinfo.size(); j++) {
					...
					jjcxiejingname+=policeinfo.get(j).getXm()+",";
				}
			}else{
	 ...
	 * @return
	 */
	public HashMap<String,Object> querypolicebybc(@RequestBody HashMap<String,Object> map){
